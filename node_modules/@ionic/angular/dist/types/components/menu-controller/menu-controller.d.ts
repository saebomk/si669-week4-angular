...
export declare class MenuController {
     ...
     */
    enable(shouldEnable: boolean, menuId?: string): Promise<HTMLIonMenuElement | null>;
    /**
     * Used to enable or disable the ability to swipe open the menu.
     */
    swipeGesture(shouldEnable: boolean, menuId?: string): Promise<HTMLIonMenuElement | null>;
    /**
     ...
     * return `null`.
     */
    get(menuId?: string): Promise<HTMLIonMenuElement | null>;
    /**
