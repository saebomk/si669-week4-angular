import { a as now, j as pointerCoord } from "./chunk-42163827.js";
function startTapClick(t) { var e, o, n = 10 * -MOUSE_WAIT, i = 0, r = !1; var c = new WeakMap; function a(t) { n = now(t), u(t); } function s() { clearTimeout(o), e && (f(!1), e = void 0), r = !0; } function d(t) { e || (r = !1, E(getActivatableTarget(t), t)); } function u(t) { E(void 0, t), r && t.cancelable && t.preventDefault(); } function E(t, n) { if (t && t === e)
